...
const TRANSLATIONS: any = {
  en: {
    ...
    'setup.welcome': 'Welcome to Haang POS', 'setup.subtitle': 'The Smartest POS for Cambodia', 'setup.create': 'Create Your Shop', 'setup.name': 'Shop Name', 'setup.type': 'Business Type', 'setup.retail': 'Retail', 'setup.restaurant': 'Restaurant', 'setup.logo': 'Logo', 'setup.gen_ai': 'Generate w/ AI', 'setup.multi_staff': 'Multi-Staff / Roles', 'setup.multi_staff_desc': 'Enable Admin, Waiter, Kitchen roles', 'setup.start': 'Start Business',
    'lock.authorized': 'Authorized Access', 'lock.who_login': 'Who is logging in?', 'lock.logout': 'Logout', 'lock.create_admin': 'Create Admin (PIN: 1234)', 'lock.no_staff': 'No staff accounts found.', 'lock.change': 'Change', 'lock.exit_demo': 'Exit Demo', 'lock.lock_screen': 'Lock Screen',
  ...
  km: {
    ...
    'setup.welcome': 'សូមស្វាគមន៍មកកាន់ Haang POS', 'setup.subtitle': 'ប្រព័ន្ធគ្រប់គ្រងហាងឆ្លាតវៃ', 'setup.create': 'បង្កើតហាងរបស់អ្នក', 'setup.name': 'ឈ្មោះហាង', 'setup.type': 'ប្រភេទអាជីវកម្ម', 'setup.retail': 'លក់រាយ', 'setup.restaurant': 'ភោជនីយដ្ឋាន', 'setup.logo': 'ឡូហ្គោ', 'setup.gen_ai': 'បង្កើតដោយ AI', 'setup.multi_staff': 'បុគ្គលិកច្រើន / តួនាទី', 'setup.multi_staff_desc': 'បើកមុខងារ Admin, អ្នករត់តុ, ផ្ទះបាយ', 'setup.start': 'ចាប់ផ្តើម',
    'lock.authorized': 'ការចូលប្រើប្រាស់', 'lock.who_login': 'តើនរណាកំពុងចូលប្រើ?', 'lock.logout': 'ចាកចេញ', 'lock.create_admin': 'បង្កើត Admin (PIN: 1234)', 'lock.no_staff': 'មិនមានគណនីបុគ្គលិកទេ។', 'lock.change': 'ប្តូរ', 'lock.exit_demo': 'ចាកចេញពី Demo', 'lock.lock_screen': 'ចាក់សោ',
  ...
  zh: {
    ...
    'setup.welcome': '欢迎使用 Haang POS', 'setup.subtitle': '柬埔寨最智能的 POS', 'setup.create': '创建您的店铺', 'setup.name': '店铺名称', 'setup.type': '业务类型', 'setup.retail': '零售', 'setup.restaurant': '餐厅', 'setup.logo': 'Logo', 'setup.gen_ai': 'AI生成', 'setup.multi_staff': '多员工/角色', 'setup.multi_staff_desc': '启用管理员、服务员、厨房角色', 'setup.start': '开始营业',
    'lock.authorized': '授权访问', 'lock.who_login': '谁在登录?', 'lock.logout': '退出', 'lock.create_admin': '创建管理员 (PIN: 1234)', 'lock.no_staff': '未找到员工账号。', 'lock.change': '更改', 'lock.exit_demo': '退出演示', 'lock.lock_screen': '锁定屏幕',
  ...
  ja: {
    ...
    'setup.welcome': 'Haang POSへようこそ', 'setup.subtitle': 'カンボジア向けのスマートPOS', 'setup.create': '店舗を作成', 'setup.name': '店名', 'setup.type': '業種', 'setup.retail': '小売', 'setup.restaurant': 'レストラン', 'setup.logo': 'ロゴ', 'setup.gen_ai': 'AI生成', 'setup.multi_staff': '複数スタッフ/役割', 'setup.multi_staff_desc': '管理者、ウェイター、キッチンの役割を有効化', 'setup.start': '営業開始',
    'lock.authorized': 'アクセス許可', 'lock.who_login': 'ログイン者は？', 'lock.logout': 'ログアウト', 'lock.create_admin': '管理者作成 (PIN: 1234)', 'lock.no_staff': 'スタッフアカウントがありません。', 'lock.change': '変更', 'lock.exit_demo': 'デモ終了', 'lock.lock_screen': '画面ロック',
  ...
  ko: {
    ...
    'setup.welcome': 'Haang POS에 오신 것을 환영합니다', 'setup.subtitle': '캄보디아를 위한 스마트 POS', 'setup.create': '매장 만들기', 'setup.name': '매장명', 'setup.type': '업종', 'setup.retail': '소매', 'setup.restaurant': '식당', 'setup.logo': '로고', 'setup.gen_ai': 'AI 생성', 'setup.multi_staff': '다중 직원/역할', 'setup.multi_staff_desc': '관리자, 웨이터, 주방 역할 활성화', 'setup.start': '영업 시작',
    'lock.authorized': '접근 권한', 'lock.who_login': '로그인 사용자?', 'lock.logout': '로그아웃', 'lock.create_admin': '관리자 생성 (PIN: 1234)', 'lock.no_staff': '직원 계정이 없습니다.', 'lock.change': '변경', 'lock.exit_demo': '데모 종료', 'lock.lock_screen': '화면 잠금',
...
export const StoreProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const createShop = async (name: string, type: 'retail' | 'restaurant', logoUrl?: string, enableMultiRoles?: boolean) => {
      ...
      try {
          ...
          // Automatically create "Owner" with PIN "1234" to prevent lockout
