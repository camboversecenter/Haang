...
const TRANSLATIONS: any = {
  en: {
    ...
    'lock.authorized': 'Authorized Access', 'lock.who_login': 'Who is logging in?', 'lock.logout': 'Logout', 'lock.create_admin': 'Create Admin (PIN: 123456)', 'lock.no_staff': 'No staff accounts found.', 'lock.change': 'Change', 'lock.exit_demo': 'Exit Demo', 'lock.lock_screen': 'Lock Screen',
  ...
  km: {
    ...
    'lock.authorized': 'ការចូលប្រើប្រាស់', 'lock.who_login': 'តើនរណាកំពុងចូលប្រើ?', 'lock.logout': 'ចាកចេញ', 'lock.create_admin': 'បង្កើត Admin (PIN: 123456)', 'lock.no_staff': 'មិនមានគណនីបុគ្គលិកទេ។', 'lock.change': 'ប្តូរ', 'lock.exit_demo': 'ចាកចេញពី Demo', 'lock.lock_screen': 'ចាក់សោ',
  ...
  zh: {
    ...
    'lock.authorized': '授权访问', 'lock.who_login': '谁在登录?', 'lock.logout': '退出', 'lock.create_admin': '创建管理员 (PIN: 123456)', 'lock.no_staff': '未找到员工账号。', 'lock.change': '更改', 'lock.exit_demo': '退出演示', 'lock.lock_screen': '锁定屏幕',
  ...
  ja: {
    ...
    'lock.authorized': 'アクセス許可', 'lock.who_login': 'ログイン者は？', 'lock.logout': 'ログアウト', 'lock.create_admin': '管理者作成 (PIN: 123456)', 'lock.no_staff': 'スタッフアカウントがありません。', 'lock.change': '変更', 'lock.exit_demo': 'デモ終了', 'lock.lock_screen': '画面ロック',
  ...
  ko: {
    ...
    'lock.authorized': '접근 권한', 'lock.who_login': '로그인 사용자?', 'lock.logout': '로그아웃', 'lock.create_admin': '관리자 생성 (PIN: 123456)', 'lock.no_staff': '직원 계정이 없습니다.', 'lock.change': '변경', 'lock.exit_demo': '데모 종료', 'lock.lock_screen': '화면 잠금',
